...
function downloadFile(type) {
    const downloadLinks = {
        main: 'https://pan.quark.cn/s/ad0e1d39858f'
    };
...
function downloadMod(type) {
    const modLinks = {
        ...
        lite: 'https://pan.quark.cn/s/8fc7846d818f'
    };
    ...
    <div class="container">
                    ...
                    <div class="mods-grid">
                        ...
                        <div class="mod-card">
                            ...
                            <h4>
                                <span>怪物十二只
                                    <span style="font-size: 13px; display: block; font-weight: 500;">版本：v1.0.0</span>
                                </span>
                                <span class="mod-type">生物模组</span>
                            </h4>
                            <p class="mod-desc" style="font-size: 12px;">
                                怪兽十二只，Minecraft生物模组，它会在Minecraft世界中生成12种独特生物，你将遇到大象、狼、鱼、恶魔、幼龙、锤子人、小机器人、企鹅、狮子等奇异生物，不同生物有不同的行为，还有不同的战斗技能，如：风刃、雷电、大地震击、闪电链等，快来体验吧！
                            </p>
                            <div>
                                <button class="mod-btn" onclick="window.open('https://pan.quark.cn/s/e9c69498b3b4');">
                                    <i class="fas fa-download"></i> 下载模组<span style="font-size: 9px; padding-left:3px;">适配MC1.19.2</span>
                                </button>
                                <button class="mod-btn" onclick="window.open('https://pan.quark.cn/s/ca5d18e92e92');">
                        ...
                        <div class="mod-card">
                            ...
                            <h4>
                                <span>武装铁傀儡
                                    <span style="font-size: 13px; display: block; font-weight: 500;">版本：v1.4.0</span>
                                </span>
                                <span class="mod-type">生物模组</span>
                            </h4>
                            <p class="mod-desc">
                                该模组为铁傀儡添加发光眼睛，并允许通过右键点击或投掷物品的方式让它们装备盔甲和武器。
                                <span style="display: inline-block; padding-top: 5px; font-weight: 600;">注：适配Minecraft v1.20.1。</span>
                            </p>
                            <button class="mod-btn" onclick="downloadMod('iron_golem')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            ...
                            <h4> 
                                <span>塔Plus
                                    <span style="font-size: 13px; display: block; font-weight: 500;">版本：v1.3.0</span>
                                </span>
                                <span class="mod-type">塔防模组</span>
                            </h4>
                            <p class="mod-desc">包含有多种塔，如：木塔、黄金塔、闪电塔等等，不同的塔有不同的技能、能力。可用来玩塔防模式。</p>
                            <button class="mod-btn" onclick="downloadMod('towers')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            <h4>
                                <span>泛光刀光
                                    <span style="font-size: 13px; display: block; font-weight: 500;">版本：v2.2.0</span>
                                </span>
                                <span class="mod-type">特效模组</span></h4>
                            <p class="mod-desc">刀光模组，可让光刀呈现非常亮丽的发光效果，提升战斗视觉体验。</p>
                            <button class="mod-btn" onclick="downloadMod('effect')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            <h4> 
                                <span>双太刀
                                    <span style="font-size: 13px; display: block; font-weight: 500;">版本：v1.0.5</span>
                                </span>
                                <span class="mod-type">武器模组</span>
                            </h4>
                            <p class="mod-desc">使玩家可以双持太刀进行战斗，有独立的战斗动作和技能。</p>
                            <button class="mod-btn" onclick="downloadMod('weapon')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            ...
                            <h4> 
                                ...
                                <span class="mod-type">技能模组</span>
                            </h4>
                            <p class="mod-desc">玩家击中目标时，有概率随机释放雷击、爆炸、火焰等技能进行二次打击。</p>
                            <button class="mod-btn" onclick="downloadMod('skill1')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            ...
                            <p class="mod-desc">玩家被攻击时，有概率触发回血、护盾、隐身等效果，增强防护能力。</p>
                            <button class="mod-btn" onclick="downloadMod('skill2')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            <h4> 
                                ...
                                <span class="mod-type">物品模组</span>
                            </h4>
                            <p class="mod-desc">以损失部分生命值为代价，在一定时间内提高攻击力的特殊药水效果。</p>
                            <button class="mod-btn" onclick="downloadMod('item')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            <h4> 
                                ...
                                <span class="mod-type">战术模组</span>
                            </h4>
                            <p class="mod-desc">用于多人联机游戏，使不同玩家处于红蓝阵营，进行团队式战斗。</p>
                            <button class="mod-btn" onclick="downloadMod('tactics')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            ...
                            <p class="mod-desc">不需要弓或弩，点击右键即可快速、连续、大量地射出箭矢。</p>
                            <button class="mod-btn" onclick="downloadMod('arrow')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            <h4> 
                                ...
                                <span class="mod-type">人工智能模组</span>
                            </h4>
                            <p class="mod-desc">用Q-learning人工智能算法加强僵尸，使它们具备自主学习能力，越来越聪明。</p>
                            <button class="mod-btn" onclick="downloadMod('zombie')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                         ...
                         <div class="mod-card">
                            <h4> 
                                ...
                                <span class="mod-type">辅助模组</span>
                            </h4>
                            <p class="mod-desc">1、显示生物血条、血量值；2、给生物名字上色，表示与自己相比的强度：绿色弱、黄色相当、红色强。</p>
                            <button class="mod-btn" onclick="downloadMod('superhp')">
                                <i class="fas fa-download"></i> 下载模组
                            </button>
                        </div>
                        ...
                        <div class="mod-card">
                            ...
                            <h4>
                                <span>铁傀儡的枪
                                    <span style="font-size: 13px; display: block; font-weight: 500;">版本：v1.2.0</span>
                                </span>
                                <span class="mod-type">生物模组</span>
                            </h4>
                            <p class="mod-desc">
                            ...
                            <div>
                                <button class="mod-btn" onclick="window.open('https://pan.quark.cn/s/cfb90af76ed5');">
                                    <i class="fas fa-download"></i> 下载模组
                                </button>
                                <button class="mod-btn btn-color" onclick="window.open('https://www.bilibili.com/video/BV1UpDPBDEHA/');">
                                    <i class="fas fa-play-circle" style="padding-right:5px;"></i>
                                    观看视频
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="mod-card">
                            ...
                            <p class="mod-desc" style="font-size: 12px;">
                                模组加载后，会自动在地图的草地区域刷新一种全新的NPC角色：“愤怒的锤子人”，一个举着锤子的老头，默认只攻击玩家，造成伤害的同时有概率释放闪电、火焰、风暴等十余种魔法。
                            </p>
                            <div>
                                <button class="mod-btn" onclick="window.open('https://pan.quark.cn/s/09814313a53f');">
                                    <i class="fas fa-download"></i> 下载模组
                                </button>
                            </div>
                        </div>
